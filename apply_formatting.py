...
def format_portfolio(filepath):
    """Apply professional formatting to portfolio Excel files"""
    ...
    action_title_font = Font(bold=True, size=9, color="1F4788")
...
if __name__ == '__main__':
    if len(sys.argv) < 2:
        print("Usage: python apply_formatting.py <filename.xlsx>")
        print("Example: python apply_formatting.py Portfolio1.xlsx")
        sys.exit(1)
    
    filename = sys.argv[1]
    try:
        format_portfolio(filename)
